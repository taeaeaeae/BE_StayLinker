...
class NotificationController(
    ...
    @GetMapping
    fun getNotificationPage(): ResponseEntity<List<NotificationResponse>> {
        return ResponseEntity.status(HttpStatus.OK).body(notificationService.getNotificationPage())
    }
